...
export default function EditJobPage({langSelected}){
    const {id} = useParams();
    // const dataToEdit = editData(id);
    ...
    console.log("edit data out fetch function");
    ...
    console.log("Setting salary to:", dataFetched?.salary || "");
    ...
    useEffect(() => {
        if (dataFetched) {
            setType(dataFetched?.type || "" );
            setTitle(dataFetched?.title || "" );
            setDescription(dataFetched?.description || "" );
            
            setSalary(dataFetched?.salary || "" );
            setLocation(dataFetched?.location || "" );

            
            const {company} = dataFetched ;
                        ...
                        <form onSubmit={submitForm} className="formContainer" >
                            ...
                            <div className="allFormElements">
                                ...
                                >
                                    ...
                                    <option value={langSelected === "en"? "Under $50K":"Kάτω από $50K"} >
                                        {langSelected === "en"? "Under $50K":"Kάτω από $50K"}</option>
